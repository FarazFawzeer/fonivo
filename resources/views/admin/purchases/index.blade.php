@extends('layouts.vertical', ['subtitle' => 'Purchase View'])

@section('content')
    @include('layouts.partials.page-title', ['title' => 'Purchases', 'subtitle' => 'View'])

    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                <h5 class="card-title mb-0">Purchase List</h5>
                <p class="card-subtitle mb-0">Supplier purchases with credit/partial/full payments.</p>
            </div>
            <div>
        ...
        <div class="card-body">
            ...
            {{-- Filters --}}
            <form method="GET" action="{{ route('admin.purchases.index') }}" class="row g-2 mb-3">
                <div class="col-md-4">
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.purchases.index') }}" class="btn btn-light w-100">Reset</a>
                </div>
            </form>
                    ...
                    <tbody>
                        @forelse($purchases as $p)
                            <tr>
                                ...
                                <td>
                                    @php
                                        $badge = $p->status === 'paid' ? 'bg-success' : ($p->status === 'partial' ? 'bg-warning' : 'bg-danger');
                                    @endphp
